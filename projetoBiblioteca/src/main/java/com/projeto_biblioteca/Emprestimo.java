...
public class Emprestimo {
    ...
    public void registrarEmprestimo() {
        if (livro.getDisponibilidade()) {
            ...
            System.out.println("Empréstimo registrado para " + membro.getNome() + " com o livro " + livro.getTitulo()
                    + " em " + dataEmprestimo);
        } else {
    ...
    public void registrarDevolucao() {
        ...
        System.out.println("Devolução registrada para " + membro.getNome() + " com o livro " + livro.getTitulo()
                + " em " + dataDevolucao);
    }
